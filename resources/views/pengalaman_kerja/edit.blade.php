<!-- resources/views/pengalaman_kerja/edit.blade.php -->
@extends('layouts.app')
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">Edit Pengalaman Kerja</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('pengalaman-kerja.update', $pengalamanKerja->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('jabatan') is-invalid @enderror" id="jabatan"
                                name="jabatan" value="{{ old('jabatan', $pengalamanKerja->jabatan) }}">
                            @error('jabatan')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nama_perusahaan') is-invalid @enderror"
                                ...
                                value="{{ old('nama_perusahaan', $pengalamanKerja->nama_perusahaan) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nama_lain_perusahaan') is-invalid @enderror"
                                ...
                                value="{{ old('nama_lain_perusahaan', $pengalamanKerja->nama_lain_perusahaan) }}">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control @error('tahun_mulai') is-invalid @enderror"
                                    ...
                                    value="{{ old('tahun_mulai', $pengalamanKerja->tahun_mulai) }}">
                                @error('tahun_mulai')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control @error('jumlah_bulan') is-invalid @enderror"
                                    id="jumlah_bulan" name="jumlah_bulan" min="1"
                                    value="{{ old('jumlah_bulan', $pengalamanKerja->jumlah_bulan) }}">
                                @error('jumlah_bulan')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input class="form-check-input @error('kerja_saat_ini') is-invalid @enderror"
                                    ...
                                    old('kerja_saat_ini', $pengalamanKerja->kerja_saat_ini) ? 'checked' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('keterangan') is-invalid @enderror" id="keterangan"
                                name="keterangan"
                                rows="3">{{ old('keterangan', $pengalamanKerja->keterangan) }}</textarea>
                            @error('keterangan')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
